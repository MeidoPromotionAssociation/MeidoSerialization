...
// GP03BridgeService 在 .brd wire framing 与完整 typed editing JSON 之间转换
// GP03BridgeService converts between .brd wire framing and fully typed editing JSON
...
func (s *GP03BridgeService) ConvertBridgeToJSON(ctx context.Context, inputPath, outputPath string, maxOutputBytes int64) error {
	...
	value, err := decodeGP03Bridge(input)
	if err != nil {
